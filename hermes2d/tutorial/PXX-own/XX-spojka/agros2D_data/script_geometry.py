...
addmaterial("osa", 0, 0, 1, 5e+06, 0, 0, 0, 0, 0)
addmaterial("izolace", 0, 0, 1, 0, 0, 0, 0, 0, 0)
addmaterial("Fe_rozt", 0, 0, 2000, 6e+06, 0, 0, 0, 0, 0)
addmaterial("Fe_nerozt", 0, 0, 350, 2e+06, 0, 0, 0, 0, 0)
addmaterial("magnet_vnitrni", 0, 0, 1, 0, 0, 0, 0, 0, 0)
addmaterial("magnet_vnejsi_obal", 0, 0, 1, 0, 0, 0, 0, 0, 0)
addmaterial("M_N", 0, 0, 1, 0, 0, 90, 0, 0, 0)
addmaterial("M_NW", 0, 0, 1, 0, 0, 45, 0, 0, 0)
addmaterial("M_W", 0, 0, 1, 0, 0, 0, 0, 0, 0)
addmaterial("M_SW", 0, 0, 1, 0, 0, 315, 0, 0, 0)
addmaterial("M_S", 0, 0, 1, 0, 0, 270, 0, 0, 0)
addmaterial("M_SE", 0, 0, 1, 0, 0, 225, 0, 0, 0)
addmaterial("M_E", 0, 0, 1, 0, 0, 0, 180, 0, 0)
addmaterial("M_NE", 0, 0, 1, 0, 0, 0, 135, 0, 0)
